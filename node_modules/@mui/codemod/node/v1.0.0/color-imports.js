    ...
    if (memberImportSpecifiers.length) {
      j(importDeclaration).replaceWith(() => {
        ...
        memberImportSpecifiers.forEach(memberSpecifier => {
          ...
          const colorIdentifier = j.identifier(colorModuleName); // import color module (if not already imported)
...
module.exports = function transformer(fileInfo, api, options = {}) {
  ...
  const targetPath = options.targetPath || '@material-ui/core/colors'; // transforms
